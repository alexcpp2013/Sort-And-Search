...
public:		// User declarations
        ...
        void __fastcall Shella(int *X, int n, int DS);
        };
//---------------------------------------------------------------------------
...
class sort_shell1 {
    private:
        ...
        int n;            //Number of data elements in the list
    public:
          sort_shell1 (int size) { X = new int[n=size]; }
          ~sort_shell1( ) { delete [ ]X; }
          void load_list (int input[ ] );
          
          void shell_sort1( int input[ ]);
};
