...
void __fastcall TfrmMain::butSortClick(TObject *Sender)
{
        ...
        /** Сортировка массива, состоящего из п элементов, в порядке возрастания
            с использованием метода пирамидальной сортнровки */
...
void  Heap :: establish_heap_property ( int root, int limit )
{
        ...
        {
                //Поиск максимального элемента между левым и правым дочерними элементами 
                /*
                ...
                */
                ...
                //Сравнение найденного максимального элемента с наибольшим значением 
                //Если наибольший элемент имеет максимальное значение, то условие пирамиды выполнено
                //и нужно выйти. 
...
void  Heap :: heap_sort( int input[ ] )
{
        ...
        for ( int i = ( heap_size - 1 ); i > 0; i-- )
        {
                ...
                // Поместить корень в отсортированную позицию 
